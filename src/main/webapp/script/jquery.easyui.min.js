...
_1d4.add(_1d5)._outerWidth(_1d3.width()-6);
...
$("<div class=\"tabs-header\">"+"<div class=\"tabs-scroller-left\"></div>"+"<div class=\"tabs-scroller-right\"></div>"+"<div class=\"tabs-wrap\"><div class=\"ty-window-menu\" id=\"tyWinMenu\"><div class=\"ty-wm-left\"></div> <div class=\"ty-wm-list\">"+"<ul class=\"tabs\"><em class=\"fr\" id=\"tyWmEnd\"></em></ul>"+"</div><div class=\"ty-wm-right\"></div></div>"+"</div>").prependTo(_2de);
...
cc.children("div.tabs-header").find("#tyWmEnd").css("padding-right",$("#tyWinMenu").width()-$("#tyWmEnd").parent().parent().width()-14);
...
opts.tab.append("<a href=\"javascript:void(0)\" class=\"tabs-inner\">"+"<span class=\"tabs-title\"></span>"+"<i class=\"tabs-icon\"></i>"+"</a>");
